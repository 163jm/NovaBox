package com.mobile.novabox.util.js;

import android.text.TextUtils;
import com.mobile.novabox.util.StringUtils;
...
public class HtmlParser {
    ...
    private static final Pattern SPECIAL_URL = Pattern.compile("^(ftp|magnet|ws):", Pattern.MULTILINE | Pattern.CASE_INSENSITIVE); // 过滤特殊链接,不走urlJoin
