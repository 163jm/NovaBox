...
public class HawkConfig {
    ...
    public static final String PLAY_TYPE = "play_type";//0 EXO硬解 1 EXO软解 2 MPV硬解 3 MPV软解
    public static final String LIVE_PLAY_TYPE = "live_play_type";//0 EXO硬解 1 EXO软解 2 MPV硬解 3 MPV软解
