...
public class HawkConfig {
    ...
    public static final String PLAY_TYPE = "play_type";//0 EXO硬解 1 EXO软解 2 IJK硬解 3 IJK软解 4 MPV硬解 5 MPV软解 10 MXPlayer
    public static final String LIVE_PLAY_TYPE = "live_play_type";//0 EXO硬解 1 EXO软解 2 IJK硬解 3 IJK软解 4 MPV硬解 5 MPV软解 10 MXPlayer
    ...
    /** 搜索：每一批并发提交的源站数量（SearchThreadHelper） */
    public static final String SEARCH_THREAD_COUNT = "search_thread_count";
    /** 搜索：线程池最大线程数上限（SearchThreadHelper） */
    public static final String SEARCH_MAX_THREAD_COUNT = "search_max_thread_count";
    public static boolean hotVodDelete;

    // 多配置管理（点播仓库/线路列表，每条格式: name\turl\troutes_json）
    public static final String VOD_CONFIG_LIST = "vod_config_list";
    // 多直播源列表，每条格式: name\turl
    public static final String LIVE_SOURCE_LIST = "live_source_list";
    public static final String LIVE_SOURCE_SELECTED = "live_source_selected"; // 选中的直播源索引
    // 当前选中的点播配置索引
    public static final String VOD_CONFIG_SEL_CONFIG = "vod_config_sel_config";
    // 当前选中的点播线路索引（在配置内）
    public static final String VOD_CONFIG_SEL_ROUTE = "vod_config_sel_route";
